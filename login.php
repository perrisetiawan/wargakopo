...
<head>
    ...
    <title>Login | RT 05</title>
    <link rel="shortcut icon" href="asset_user/img/logo.png" type="image/x-icon">
            ...
            <div class="signin-content">
                ...
                <div class="signin-form" style="margin-top: 2rem;">
                    <div class="display-flex-center">
                        <img src="asset_user/img/logo.png" alt="" width="50px">
                        <h4>
                            Sistem Informasi & Manajemen <br>
                            RT 05 RW 01 Desa Kopo
                        </h4>
                    </div>
