    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                <h1>Informasi RT 05 RW 01</h1>
                <p style="text-align: justify;">
                    Sistem Kependudukan ini merupakan suatu sistem yang dapat mengolah data kependudukan yang berada di <?= $row_profil->nama_desa; ?> menjadi Data Klasifikasi kependudukan dan Data Klasifikasi Bantuan.
                </p>
                <div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="jenis_bantuan" name="jenis_bantuan" class="form-control pencek">
                                            ...
                                            <option value="BLT">Bantuan BLT-Dana Desa</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<main id="main">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <p class="description">Jumlah penduduk yang berkerja sebagai pabrik di <?= $row_profil->nama_desa; ?> adalah <b><?= mysqli_num_rows($sql_industri); ?></b> Jiwa</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <p class="description">Jumlah penduduk yang sudah/sebagai Pensiunan di <?= $row_profil->nama_desa; ?> adalah <b><?= mysqli_num_rows($sql_pensiun); ?></b> Jiwa</p>
                    </div>
                </div>
                ...
                ?>
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                            ...
                            <p class="description">
                                Jumlah penduduk yang berada di <?= $row_profil->nama_desa; ?> adalah
                                <b>
                                    <?php
    ...
    <section id="contact" class="contact">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                <h2>Hubungi Kami</h2>
                <p>Untuk infromasi lebih lanjut</p>
            </div>
