                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr align="center">
                                        <th rowspan="3" style="vertical-align: middle; text-align: center;">NO</th>
                                        <th rowspan="3" style="vertical-align: middle; text-align: center;">DUSUN</th>
                                        <th colspan="22" style="vertical-align: middle; text-align: center;">Pekerjaan Utama</th>
                                        <th rowspan="3" style="vertical-align: middle; text-align: center;">JUMLAH</th>
                                    </tr>
                                    <tr align="center">
                                        ...
                                        <th colspan="2" style="vertical-align: middle; text-align: center;">Pedagang Kecil</th>
                                        <th colspan="2" style="vertical-align: middle; text-align: center;">Pedagang Besar</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr align="center">
                                            ...
                                            <!-- Pedagang Kecil -->
                                            <?php
                                            $query_pekerjaanlaki = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Kecil' AND tabel_kependudukan.JK = '1' AND tabel_kependudukan.DSN = '$rowpu[id]'");
                                            $row_pekerjaanlaki = $query_pekerjaanlaki->fetch_assoc();
                                            $query_pekerjaanperempuan = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Kecil' AND tabel_kependudukan.JK = '2' AND tabel_kependudukan.DSN = '$rowpu[id]'");
                                            $row_pekerjaanperempuan = $query_pekerjaanperempuan->fetch_assoc();
                                            ?>
                                            <td style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanlaki['ttl'] ?></td>
                                            <td style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanperempuan['ttl'] ?></td>
                                            <!-- // -->
                                             ...
                                             <!-- Pedagang Besar -->
                                            <?php
                                            $query_pekerjaanlaki = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Besar' AND tabel_kependudukan.JK = '1' AND tabel_kependudukan.DSN = '$rowpu[id]'");
                                            $row_pekerjaanlaki = $query_pekerjaanlaki->fetch_assoc();
                                            $query_pekerjaanperempuan = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Besar' AND tabel_kependudukan.JK = '2' AND tabel_kependudukan.DSN = '$rowpu[id]'");
                                            $row_pekerjaanperempuan = $query_pekerjaanperempuan->fetch_assoc();
                                            ?>
                                            <td style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanlaki['ttl'] ?></td>
                                            <td style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanperempuan['ttl'] ?></td>
                                ...
                                <tfoot>
                                    <tr align="center">
                                        ...
                                        <!-- Pedagang Kecil-->
                                        <?php
                                        $query_pekerjaanlaki = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Kecil' AND tabel_kependudukan.JK = '1'");
                                        $row_pekerjaanlaki = $query_pekerjaanlaki->fetch_assoc();
                                        $query_pekerjaanperempuan = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Kecil' AND tabel_kependudukan.JK = '2'");
                                        $row_pekerjaanperempuan = $query_pekerjaanperempuan->fetch_assoc();
                                        ?>
                                        <th style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanlaki['ttl'] ?></th>
                                        <th style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanperempuan['ttl'] ?></th>
                                        <!-- // -->
                                         ...
                                         <!-- Pedagang Besar-->
                                        <?php
                                        $query_pekerjaanlaki = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Besar' AND tabel_kependudukan.JK = '1'");
                                        $row_pekerjaanlaki = $query_pekerjaanlaki->fetch_assoc();
                                        $query_pekerjaanperempuan = $mysqli->query("SELECT count(tabel_kependudukan.NIK) AS ttl FROM tabel_kependudukan JOIN tabel_pekerjaan ON tabel_kependudukan.NIK = tabel_pekerjaan.NIK WHERE tabel_pekerjaan.PEKERJAAN = 'Pedagang Besar' AND tabel_kependudukan.JK = '2'");
                                        $row_pekerjaanperempuan = $query_pekerjaanperempuan->fetch_assoc();
                                        ?>
                                        <th style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanlaki['ttl'] ?></th>
                                        <th style="vertical-align: middle; text-align: center;"><?= $row_pekerjaanperempuan['ttl'] ?></th>
