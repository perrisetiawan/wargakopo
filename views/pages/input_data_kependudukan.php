                     ...
                     <div class="col-md-6">
                         ...
                         <div class="form-group">
                             ...
                             <select class="form-control select2" name="pend_terakhir" style="width: 100%;">
                                 ...
                                 <option value="S1 dan Sederajat">S1</option>
                             </select>
                         </div>
                         <div class="form-group">
                             ...
                             <select class="form-control select2" name="pekerjaan" style="width: 100%;">
                                 ...
                                 <option value="Pengolahan/Industri">Pabrik</option>
                         ...
                         <div class="form-group">
                             ...
                             <input type="float" name="penghasilan" class="form-control" id="" placeholder="Penghasilan Per Bulan  ">
                         </div>
                         <div class="form-group">
